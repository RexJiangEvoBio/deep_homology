...
g=g+scale_x_continuous(limits=c(4,51),breaks=c(5,10,15,20,25,30,35,40,45,50))+scale_y_continuous(limits=c(0,1.8),breaks=c(0,0.5,1,1.5))
ggsave("plot_exp_var.pdf",plot=g,width=7,height=5)
...
ggsave("plot_exp_div.pdf",plot=h,width=7,height=5)
...
ggsave("plot_fitness.pdf",plot=f,width=7,height=5)
